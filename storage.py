...
Ordering of versions in the database:
	...
	sorted in descending order of occurence, that is the first row(s) (if concurrent write) of the response will be the highest vector clock counts and the last row(s) will be the smallest.
...
class Storage(object):
	...
	def __init__(self, table_path):
		self.connectDB(table_path)

	def connectDB(self,table_path):
